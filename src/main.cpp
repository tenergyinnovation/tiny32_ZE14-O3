/***********************************************************************
 * Project      :     tiny32_ZE14-O3
 * Description  :     this code is template source code Interface test
 *                    between tiny32 and The ZE14-O3 Ozone Sensor/ O3 Gas Sensor Module
 * Hardware     :     tiny32_v4
...
{
  Serial.printf("\r\n***********************************************************************\r\n");
  Serial.printf("* Project      :     tiny32_ZE14-O3\r\n");
  Serial.printf("* Description  :     this code is template source code Interface test  \r\n");
  Serial.printf("*                    between tiny32 and The ZE14-O3 Ozone Sensor/ O3 Gas Sensor Module \r\n");
...
ZE14 sensor(Uart2); // connect to and replace with any available UART on your board
